...
class LineBotController extends Controller
{
    ...
    private function listCommand($member = true)
    {
        ...
        if ($this->lineMessage === '1'){
            if($member) {
                $messageCompose[] = "ขั้นตอนการยกเลิกการเชื่อมต่อกับ Eranwan CMS Officials";
                $messageCompose[] = "-----------------------";
            ...
            $messageCompose[] = "-----------------------";
            $messageCompose[] = "หากท่านมีข้อสงสัยหรือต้องการสอบถามรายละเอียดเพิ่มเติม กรุณาติดต่อ PPSmartProduct Staff 081-063-9313 🎉";
        } else if($this->lineMessage === '3'){
            $messageCompose[] = "Erawan CMS";
            $messageCompose[] = "-----------------------";
            $messageCompose[] = "Erawan Co., Ltd.";
            $messageCompose[] = "https://erawancms.com";
        }else{
            $messageCompose[] = "พิมพ์หมายเลข เพื่อเลือกฟังก์ชันที่ต้องการใช้งาน";
            $messageCompose[] = "-----------------------";
            $messageCompose[] = ($member ? "[1] ยกเลิกการเชื่อมต่อกับระบบ Erawan CMS" : "[1] เชื่อมต่อกับระบบ Erawan CMS");
            $messageCompose[] = "[2] ขอความช่วยเหลือการใช้งาน";
            $messageCompose[] = "[3] ข้อมูลบริษัทเอราวัณ";
            if($member){
